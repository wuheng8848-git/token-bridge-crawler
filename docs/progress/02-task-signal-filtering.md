...
|----------|------|-----------|--------|
| noise | 465 | 28.1 | 0.6% |
| competitor | 245 | 49.9 | 0% |
| feature | 40 | 56.0 | 0% |
| cost_pressure | 24 | 62.2 | 0% |
| user_pain | 20 | 60.9 | 0% |
| migration | 6 | 53.2 | 0% |

**验证结论**:
1. ✅ 噪声过滤有效 - 465条噪声，噪声率仅0.6%
2. ✅ 信号分层清晰 - 迁移意愿、竞品动态等高价值信号成功识别
3. ✅ 质量评分合理 - 信号类平均50+分，噪声类28分
...
2. **噪声过滤有效** - 噪声率仅0.6%-14.7%
3. **信号分层清晰** - 迁移意愿、竞品动态等高价值信号成功识别
4. **质量评分合理** - 信号类平均50-68分，噪声类28分
5. **Tavily采集成功** - 129条数据，75条migration信号，验证规则有效
5. **数据分布不均** - 价格数据过多，需要Tavily补充用户讨论数据
